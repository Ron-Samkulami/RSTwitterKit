                                 ...
                                 isMediaUpload: Bool = false) -> String
  {
    ...
    /// [RFC-5849 Section 3.4.2](https://tools.ietf.org/html/rfc5849#section-3.4.2)
      if #available(iOS 13.0, *) {
          ...
          // MARK: TODO
          // Make oauth_signature on earlier versions
      }
...
internal extension URLRequest
{
                          ...
                          consumerCredentials cc: OAuthHelper.Credentials, userCredentials uc: OAuthHelper.Credentials? = nil)
  {
    ...
    let body = OAuthHelper.httpBody(forFormParameters: paras)
    ...
    let sig = OAuthHelper.calculateSignature(url: self.url!, method: self.httpMethod!,
